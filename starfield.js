...
(function () {
  var css =
    ...
    'background-size:100% 100svh, 100% 100svh, 100% 100svh, 100% 150svh, 100% 190svh;' +
    'background-image:' +
    ...
    'radial-gradient(ellipse at 80% 50%, rgba(30,85,200,0.36) 0%, transparent 35%),' +
    'radial-gradient(ellipse at 20% 50%, rgba(15,135,135,0.30) 0%, transparent 35%);}' +
